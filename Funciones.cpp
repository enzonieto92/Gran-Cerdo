...
void pedir_nombre (char nombre1[]){
        borrar_pantalla();
cout <<"introduzca el nombre del Jugador N°1"<<endl;
cin >>nombre1;
}
void pedir_nombre2 (char nombre2[]){
        borrar_pantalla();
cout <<"introduzca el nombre del Jugador N°2"<<endl;
cin >>nombre2;
}
...
case 0:
        borrar_pantalla();
        cout <<"Veamos quién empieza!"<<endl<<endl;
...
case 2:
        ...
        if (punt_j1 >punt_j2){
            cout <<nombre1<< " ha sacado el mayor puntaje con "<<punt_j1<<" puntos!"<<endl<<endl<<"Será el primer jugador en lanzar"<<endl<<endl;
            primer_jugador = 0;
            bandera_turno = 3;
            pausa();
            break;
        ...
        // Pregunto si el puntaje del Jugador 2 es el mayor
            ...
            cout <<nombre2<< " ha sacado el mayor puntaje con "<<punt_j2<<" puntos!"<<endl<<endl<<"Será el primer jugador en lanzar"<<endl<<endl;
            primer_jugador = 1;
            bandera_turno = 3;
            pausa();
            break;
       ...
       //Asumimos que la única alternativa es que los puntajes sean iguales, y evalúo el vector para buscar el dado más grande
        ...
        // For para buscar el máximo de los dados y alojar su dirección de memoria en la variable "y"
                ...
                for (z = 0; z <4 && z!=y; z++){
                    ...
                    cout <<"Empataron todos los dados! Tiran ambos devuelta"<<endl<<endl;
                    bandera_turno = 0;
                    break;
                    }
                else{
...
//(La variable primer_jugador va a definir quién empieza el juego)
        if (y == 1 ||  y == 0){
                        cout <<"Empataron! pero "<<nombre1<<" sacó el dado mas alto!"<<endl<<endl;
                        cout <<"Será el primero en jugar..."<<endl;
                        primer_jugador = 0;
                        break;
                    }
        else if (y == 2 || y == 3){
        cout<< "Empataron! pero "<<nombre2<< " sacó el dado mas alto!"<<endl<<endl;
        cout <<"Será el primero en jugar..."<<endl;
        primer_jugador = 1;
        break;
